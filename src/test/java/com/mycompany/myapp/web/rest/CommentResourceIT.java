...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        Comment comment = new Comment().contant(DEFAULT_CONTANT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity() {
        Comment comment = new Comment().contant(UPDATED_CONTANT);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getContant()).isEqualTo(DEFAULT_CONTANT);
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.contant(UPDATED_CONTANT);
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getContant()).isEqualTo(UPDATED_CONTANT);
    }
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.contant(UPDATED_CONTANT);

...
class PostResourceIT {
    ...
    private static final String DEFAULT_CONTANT = "AAAAAAAAAA";
    private static final String UPDATED_CONTANT = "BBBBBBBBBB";
    ...
    public static Post createEntity() {
        Post post = new Post().title(DEFAULT_TITLE).contant(DEFAULT_CONTANT);
        return post;
    }
    ...
    public static Post createUpdatedEntity() {
        Post post = new Post().title(UPDATED_TITLE).contant(UPDATED_CONTANT);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getContant()).isEqualTo(DEFAULT_CONTANT);
    }
    ...
    void getAllPosts() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.[*].contant").value(hasItem(DEFAULT_CONTANT)));
    }
    ...
    void getPost() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.contant").value(DEFAULT_CONTANT));
    }
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).contant(UPDATED_CONTANT);
        ...
        assertThat(testPost.getContant()).isEqualTo(UPDATED_CONTANT);
    }
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).contant(UPDATED_CONTANT);

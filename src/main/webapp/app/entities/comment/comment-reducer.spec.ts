...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './comment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMENT actions', async () => {
      const expectedActions = [
        {
